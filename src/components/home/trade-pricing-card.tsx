  ...
  return (
    <article className="rounded-(--r-md) border border-line bg-surface-1 p-5">
      <div className="flex items-start gap-3.5">
        <UserRound size={30} strokeWidth={1.4} className="mt-0.5 shrink-0 text-ink-1" aria-hidden="true" />
        <div className="min-w-0">
          ...
          <p className="mt-2.5 text-sm leading-6 text-ink-2">
            Sign in to see your net price. New accounts are reviewed by staff before
            pricing is released.
          </p>
        </div>
      </div>
      <LinkButton href="/dealers" variant="secondary" className="mt-4 w-full" data-conversion-hook="trade-account-apply">
